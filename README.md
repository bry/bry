...
- Sportsara - A simple app that estimates personal calories burned per point played through badminton match score reporting
    ...
    - Later, additional verified match video upload verified match results & ELO service
...
- Brief How Sportsara Works:
  ...
  - Problem: Sportsara fixes the fragmented, subjective and gatekept player level rating systems in badminton, chess, table tennis, pickleball and other applicable sports. Sportsara makes ELO open peer-to-peer, and makes badminton level rating fair, accessible, objective and fun for everyone.
