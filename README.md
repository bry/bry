...
- Sportsara - A simple app that estimates personal calories burned per point played through match score reporting
    - Optionally, app offers a way to track badminton doubles players build pair ratings
